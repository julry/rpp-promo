...
export const HowBlock = ({wrapperRef}) => {
    const [ovalXDis, setOvalXDis] = useState(0);
    ...
    return (
        <div className={styles.howBlock} ref={wrapperRef}>
            ...
            <svg className={styles.howBlockTrajectory} viewBox="0 0 747 222" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="trajectory" d="M0.671875 202.473C40.8385 222.64 137.272 241.573 201.672 155.973C282.172 48.973 452.172 -48.027 587.672 29.473C696.072 91.473 737.839 144.64 745.172 163.473" stroke="#ED1C24" stroke-width="3" stroke-dasharray="6 6"/>
            </svg>
            <svg className={styles.howBlockTrajectory} viewBox="0 0 184 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="trajectoryMob" d="M1.50061 0.0217185C1.72812 15.7314 13.4211 43.9426 58.3731 31.1106C114.563 15.0707 184.468 22.7726 181.656 78.8207C179.406 123.659 167.47 150.374 161.783 158.127" stroke="#ED1C24" stroke-width="3" stroke-dasharray="6 6"/>
            ...
            <motion.img 
                ...
                animate={isParentInView ? { offsetDistance: "100%", scale: 3.2, x: ovalXDis } : {}}
            ...
            <motion.img 
                ...
                style={{offsetPath: `url("#trajectoryMob")`, offsetRotate: '0deg', x: ovalXDis}}
